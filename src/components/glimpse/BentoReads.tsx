...
export default function BentoReads({ reads }: { reads: GlimpseReads }) {
  return (
    <div className="bc bc-reads">
      ...
      <div className="book-inner" style={{ display: 'flex', gap: '18px', alignItems: 'flex-start', marginTop: '12px' }}>
        ...
        <div style={{ overflow: 'hidden', minWidth: 0 }}>
          ...
          {/* quote-text: clamp to 4 lines via CSS .book-quote class */}
          <div className="book-quote" style={{ fontSize: '12px', color: 'var(--text-secondary)', lineHeight: 1.65, fontStyle: 'italic' }}>
            &quot;{reads.quote}&quot;
          </div>
        </div>
      </div>
